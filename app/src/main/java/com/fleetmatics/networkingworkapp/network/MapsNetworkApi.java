 ...
 */
public class MapsNetworkApi<API> {
    private static final String TAG = MapsNetworkApi.class.getSimpleName();
    private final String BASE_PATH_API;
    public Retrofit retrofit;
    private API apiService;
    private Class<API> apiClass;

    public MapsNetworkApi(@NonNull String basePath, @NonNull Class<API> apiClass) {
